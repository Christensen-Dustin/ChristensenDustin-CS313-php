...
foreach ($db->query("select family_reward_fk, reward_pk, parent_fname, parent_lname, parent_bday, parent_display from family, reward, parent where family_reward_fk = '$rewards' and reward_pk = '$rewards'") as $rowParent)
{
...
foreach ($db->query("select family_reward_fk, child_fname, child_lname, child_bday, child_display from family, reward, child where family_reward_fk = '$rewards' and reward_pk = '$rewards'") as $rowChild)
{
