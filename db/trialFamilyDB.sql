...
-- Chores
insert into family (family_chore_fk, family_parent_fk, family_child_fk, family_account_fk)
    values (1, 1, 2, 1);
insert into family (family_chore_fk, family_parent_fk, family_child_fk, family_account_fk)
    values (2, 1, 1, 1);
...
-- Rewards
insert into family (family_reward_fk, family_parent_fk, family_child_fk, family_account_fk)
    values (1, 2, 2, 1);
insert into family (family_reward_fk, family_parent_fk, family_child_fk, family_account_fk)
    values (2, 2, 1, 1);
insert into family (family_reward_fk, family_parent_fk, family_child_fk, family_account_fk)
