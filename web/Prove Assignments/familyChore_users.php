...
echo '<h2> Chores </h2>';
foreach ($db->query("select parent_pk, parent_display, family_pk, chore_name, family_chore_fk, family_parent_fk from parent, chore, family where parent_display='$display' and family_pk = '$id'") as $rowFamily)
{
